...
# Function to run the first script (Daily Indicators Strategy)
def run_daily_indicators_strategy():
...
# Function to run the second script (Dynamic Strategy)
...
daily_strategy_thread = threading.Thread(target=run_daily_indicators_strategy)
dynamic_strategy_thread = threading.Thread(target=run_dynamic_strategy)

# Start the threads
daily_strategy_thread.start()
dynamic_strategy_thread.start()

# Wait for both threads to complete
daily_strategy_thread.join()
dynamic_strategy_thread.join()
